...
exports.routingExactOutput = exports.routingExactInput = exports.v2RoutingExactOutput = exports.v2RoutingExactInput = exports.v3RoutingExactOutputSingle = void 0;
...
var v2RoutingExactInput = function (tokenIn, tokenOut, tokenInAmount) { return __awaiter(void 0, void 0, void 0, function () {
    var bestRoute, maxAmountOut, directResult, error_1, calls, intermediateTokens, _i, defaultTokens_1, intermediateToken, callData, aggregateResult, results, i, amountOut, error_2;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                bestRoute = [];
            ...
            case 3:
                error_1 = _a.sent();
                console.log("Error in direct route calculation:", error_1);
                return [3 /*break*/, 4];
            case 4:
                calls = [];
                intermediateTokens = [];
...
var v2RoutingExactOutput = function (tokenIn, tokenOut, tokenOutAmount) { return __awaiter(void 0, void 0, void 0, function () {
    var bestRoute, minAmountIn, directResult, error_3, calls, intermediateTokens, _i, defaultTokens_2, intermediateToken, callData, aggregateResult, error_4;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                bestRoute = [];
